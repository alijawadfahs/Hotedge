...
\item Container-to-container communication within a pod is enabled
  ...
  machine.\noteaf{Container to container communication is done in the localhost or by sharing a resource  of the Pod, however the Pod to Pod communication uses the CNI for communication which's not limited to single node. \url{https://kubernetes.io/docs/concepts/workloads/pods/pod}}
