...
Clouds have offered the separation of the user and the hardware\unsure{can we say this ?}, such separation of duties between the cloud provider who is responsible for the management of the storage and compute resources, and the clouds user who is {\em ---thanks to cloud computing---} responsible for running and optimizing his application only.
...
%Platforms for fog.
Fog computing servers run on top of platforms like Docker swarm, Mesos, and most importantly Kubernetes.\change{not satisfied!}
