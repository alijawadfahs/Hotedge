...
\ref{road}, we suggest the next steps through a roadmap. In the last section, we conclude.\change{add something to the conclude}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Fog Computing %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Fog Computing Platforms}\label{plat}
\hskip .5em For the fog architecture to function a set of infrastructure management tools are mandatory. In our search for a proper platform we have focused on the ones that support containers, for the lightweight and portability containers offer over Virtual Machines. 
...
\hskip .7em While building our own test-bed cluster and running K8's on top of it, and by looking deeper in the code, we have spotted some of the drawbacks for running K8's for the fog, the draw-backs can be summarized in the following: 
